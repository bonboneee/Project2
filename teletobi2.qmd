...
display(HTML('<iframe src="map_nhbh_colorful.html" width="100%" height="800px"></iframe>'))
...
```{python}
# HTML 파일을 iframe으로 불러오기
display(HTML('<iframe src="map_nhbh_all_gray.html" width="100%" height="800px"></iframe>'))
