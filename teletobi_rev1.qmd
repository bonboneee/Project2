...
### Column {width=50%}
<img src="img/1944flood_paper1a.jpg" style="height:485px;">
...
### Column {width=50%}
::: {.card title="내구성과 장점" class="card-title-3"}
...
- <div style="background-color: #EDE7F6; padding: 10px; border-radius: 5px;">**조사 대상**: Ames 사람들이 선호하는 외장재의 변화.</div>

- <div style="background-color: #FFFDE7; padding: 10px; border-radius: 5px;">**목적**: 인테리어 사업을 하는 회사에 도움 제공.</div>

- <div style="background-color: #FFEBEE; padding: 10px; border-radius: 5px;">**적용 가능성**: Ames 주민뿐만 아니라 비슷한 환경의 다른 지역에서도 유용.</div>

- <div style="background-color: #E8F5E9; padding: 10px; border-radius: 5px;">**트렌드 인사이트**: 앞으로 사람들이 외장재를 선택하는 트렌드에 대한 인사이트 제공.</div>
